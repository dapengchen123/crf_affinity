...
class VerifiEvaluator(object):
    def __init__(self, cnnmodel, classifiermodel):
        super(VerifiEvaluator, self).__init__()
    ...
    def evaluate(self, queryloader, galleryloader,  query, gallery):
        ...
        scores = self.sim_computation(galleryloader, query_features)

        ### crf propgation ###
        scores = scores.data

        return evaluate_all(1 - scores, query=query, gallery=gallery)